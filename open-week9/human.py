...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/U8PNS4KEC/F9LJS74NA/human.py?nojsmode=1" /></noscript>
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
		...
		window.addEventListener('load', function() {
	        ...
	        <title>human.py | ga306-wi18 Slack</title>
	...
	<div id="site_nav_contents">
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/296358770563?crumb=s-1520397884-4c2e29bea29021724b035ff5a90f38194a812e879b2fd0b1f449f7258f11afb0-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<p class="print_only">
	...
	Created by Justin on Tuesday, March 6, 2018 at 10:08 PM
	</strong><br />
	<span class="subtle_silver break_word">https://ga306-wi18.slack.com/files/U8PNS4KEC/F9LJS74NA/human.py</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T8QAJNNGK-F9LJS74NA-a74859ce3c" target="new">https://slack-files.com/T8QAJNNGK-F9LJS74NA-a74859ce3c</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		2KB Python snippet created on <span class="date">March 6, 2018</span>.
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents">class Human(object):
	...
	<form action="https://ga306-wi18.slack.com/files/U8PNS4KEC/F9LJS74NA/human.py"
		...
		<input type="hidden" name="crumb" value="s-1520397884-06cd84a2344860b2fbfcdade3740e3024bb747335a1640c2361368ac8ecb71ed-☃" />
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/codemirror_load.8ea25ec130b83b6e874e.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F9LJS74NA","created":1520395710,"timestamp":1520395710,"name":"human.py","title":"human.py","mimetype":"text\/plain","filetype":"python","pretty_type":"Python","user":"U8PNS4KEC","editable":true,"size":2198,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T8QAJNNGK-F9LJS74NA\/human.py","url_private_download":"https:\/\/files.slack.com\/files-pri\/T8QAJNNGK-F9LJS74NA\/download\/human.py","permalink":"https:\/\/ga306-wi18.slack.com\/files\/U8PNS4KEC\/F9LJS74NA\/human.py","permalink_public":"https:\/\/slack-files.com\/T8QAJNNGK-F9LJS74NA-a74859ce3c","edit_link":"https:\/\/ga306-wi18.slack.com\/files\/U8PNS4KEC\/F9LJS74NA\/human.py\/edit","preview":"class Human(object):\n    \"\"\"A basic class to demonstrate some properties of Python classes\"\"\"\n    ## constant factor to convert pounds to kilograms\n    kPoundsToKg = 0.4536;\n    ## constant factor to convert feet to meters","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eclass\u003C\/span\u003E \u003Cspan class=\"cm-def\"\u003EHuman\u003C\/span\u003E(\u003Cspan class=\"cm-builtin\"\u003Eobject\u003C\/span\u003E):\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E    \u003Cspan class=\"cm-string\"\u003E&quot;&quot;&quot;A basic class to demonstrate some properties of Python classes&quot;&quot;&quot;\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E    \u003Cspan class=\"cm-comment\"\u003E## constant factor to convert pounds to kilograms\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E    \u003Cspan class=\"cm-variable\"\u003EkPoundsToKg\u003C\/span\u003E = \u003Cspan class=\"cm-number\"\u003E0.4536\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E    \u003Cspan class=\"cm-comment\"\u003E## constant factor to convert feet to meters\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":60,"lines_more":55,"preview_is_truncated":true,"channels":["C8QH4KBTP"],"groups":[],"ims":[],"comments_count":0};
...
<!-- slack-www-hhvm-002dfa0c07465352d / 2018-03-06 20:44:44 / vea5b484adc53ac4f7a8ae598fc5765165102d812 / B:H -->
