...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/U8PNS4KEC/F9LJSBYUE/classes_example.py?nojsmode=1" /></noscript>
...
(function() {
	...
	<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/webpack.manifest.4975835644ae816c395b.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
		...
		window.addEventListener('load', function() {
	        ...
	        <title>classes_example.py | ga306-wi18 Slack</title>
    ...
    <link href="https://a.slack-edge.com/e9747/style/rollup-slack_kit_legacy_adapters.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">

			<!-- output_css "core" -->
    <link href="https://a.slack-edge.com/648c1/style/rollup-plastic.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
    ...
    <link href="https://a.slack-edge.com/019f2/style/rollup-file_pages.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
	...
	<div id="site_nav_contents">
		...
		<div id="user_menu">
			<div id="user_menu_contents">
				<div id="user_menu_avatar">
										<span class="member_image thumb_48" style="background-image: url('https://avatars.slack-edge.com/2018-01-16/299257241152_11ecf2ac46c39484d638_192.jpg')" data-thumb-size="48" data-member-id="U8RH2JPU7"></span>
					<span class="member_image thumb_36" style="background-image: url('https://avatars.slack-edge.com/2018-01-16/299257241152_11ecf2ac46c39484d638_72.jpg')" data-thumb-size="36" data-member-id="U8RH2JPU7"></span>
				</div>
				<h3>Signed in as</h3>
				<span id="user_menu_name">Brittany</span>
			</div>
		</div>
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/296358770563?crumb=s-1520397872-52a214eacf5573b4b117590029e994e077caba4a7a68cf8685a5868a93a69697-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
		...
		<div class="header_nav">
			<div class="header_btns float_right">
				...
				<ul id="header_plans_nav" data-qa="plans_switcher_menu">
					...
					<li class="plans_switcher_item "><a data-clog-event="UPGRDEXP_PLANS_IN_TEAM_NAV" data-clog-ui-element="pricing_link" data-clog-ui-action="click" data-clog-ui-step="TEAM_NAV_PLANS_MENU"href="https://slack.com/pricing?ui_element=5&ui_step=222">
...
<li class="active">
	<a href="https://ga306-wi18.slack.com/home" target="https://ga306-wi18.slack.com/">
					<i class="ts_icon small ts_icon_check_circle_o active_icon s"></i>
							<i class="team_icon small default">G</i>
				<span class="switcher_label team_name">ga306-wi18</span>
	</a>
...
<p class="print_only">
	...
	Created by Justin on Tuesday, March 6, 2018 at 10:09 PM
	</strong><br />
	<span class="subtle_silver break_word">https://ga306-wi18.slack.com/files/U8PNS4KEC/F9LJSBYUE/classes_example.py</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T8QAJNNGK-F9LJSBYUE-35cd4b56a9" target="new">https://slack-files.com/T8QAJNNGK-F9LJSBYUE-35cd4b56a9</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		542b Python snippet created on <span class="date">March 6, 2018</span>.
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents">class Duck:
    def quack(self):
        print(&quot;Quaaaaaack!&quot;)
    def feathers(self):
...
game()
	...
	<form action="https://ga306-wi18.slack.com/files/U8PNS4KEC/F9LJSBYUE/classes_example.py"
			id="file_comment_form"
							class="comment_form clearfix"
						method="post">
					<a href="/team/U8RH2JPU7" class="member_preview_link" data-member-id="U8RH2JPU7" >
				<span class="member_image thumb_36" style="background-image: url('https://avatars.slack-edge.com/2018-01-16/299257241152_11ecf2ac46c39484d638_72.jpg')" data-thumb-size="36" data-member-id="U8RH2JPU7"></span>
			</a>
				<input type="hidden" name="addcomment" value="1" />
		<input type="hidden" name="crumb" value="s-1520397872-9214bfbe17037d99dd96038620234c26893bd0f09b93da2192762b76a7f57404-☃" />
...
<!--
	...
	var boot_data = {
		...
		user_id: 'U8RH2JPU7',
		team_id: 'T8QAJNNGK',
		visitor_uid: ".eb5j89yzau8kookkg888s4s00",
		no_login: false,
		version_ts: "1520390820",
		version_uid: "ea5b484adc53ac4f7a8ae598fc5765165102d812",
		...
		api_url: '/api/',
		team_url: "https:\/\/ga306-wi18.slack.com\/",
		image_proxy_url: "https:\/\/slack-imgs.com\/",
		beacon_timing_url: "https:\/\/slack.com\/beacon\/timing",
		beacon_error_url: "https:\/\/slack.com\/beacon\/error",
		clog_url: "clog\/track\/",
		api_token: "xoxs-296358770563-297580635959-325102185008-e695ad2951",
		ls_disabled: false,
		hc_tracking_qs: "sid=zd-uf-t8qajnngk-u8rh2jpu7",
	...
	codemirror_files: {
		...
		feature_modern_ensure_members: true,
		...
		feature_i18n_conversation_channel: true,
		...
		feature_mrkdwn_truncation: false,
		...
		feature_wta_config_pages_update: true,
		feature_sli_explore: false,
		feature_sli_trending_dashboard: false,
		feature_sli_trending_myinsights: false,
		...
		feature_channel_browser_dropdown: false,
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_required_libs.4cb27bd13158686e0797.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/application.c34a7ae20d23fef3700c.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

		<!-- output_js "core" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_required_ts.92ccf9824afa07b0fe77.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/TS.web.6c2392feae7af57ef7dd.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!-- output_js "core_web" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_web.9c3d3c9e5b73d044eacb.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "secondary" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-secondary_a_required.dd989dc1f596e31a2b2c.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-secondary_b_required.c95d41c0b52ceff6014f.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/codemirror_load.8ea25ec130b83b6e874e.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F9LJSBYUE","created":1520395752,"timestamp":1520395752,"name":"classes_example.py","title":"classes_example.py","mimetype":"text\/plain","filetype":"python","pretty_type":"Python","user":"U8PNS4KEC","editable":true,"size":542,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T8QAJNNGK-F9LJSBYUE\/classes_example.py","url_private_download":"https:\/\/files.slack.com\/files-pri\/T8QAJNNGK-F9LJSBYUE\/download\/classes_example.py","permalink":"https:\/\/ga306-wi18.slack.com\/files\/U8PNS4KEC\/F9LJSBYUE\/classes_example.py","permalink_public":"https:\/\/slack-files.com\/T8QAJNNGK-F9LJSBYUE-35cd4b56a9","edit_link":"https:\/\/ga306-wi18.slack.com\/files\/U8PNS4KEC\/F9LJSBYUE\/classes_example.py\/edit","preview":"class Duck:\n    def quack(self):\n        print(\"Quaaaaaack!\")\n    def feathers(self):\n        print(\"The duck has white and gray feathers.\")","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eclass\u003C\/span\u003E \u003Cspan class=\"cm-def\"\u003EDuck\u003C\/span\u003E:\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E    \u003Cspan class=\"cm-keyword\"\u003Edef\u003C\/span\u003E \u003Cspan class=\"cm-def\"\u003Equack\u003C\/span\u003E(\u003Cspan class=\"cm-variable-2\"\u003Eself\u003C\/span\u003E):\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E        \u003Cspan class=\"cm-keyword\"\u003Eprint\u003C\/span\u003E(\u003Cspan class=\"cm-string\"\u003E&quot;Quaaaaaack!&quot;\u003C\/span\u003E)\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E    \u003Cspan class=\"cm-keyword\"\u003Edef\u003C\/span\u003E \u003Cspan class=\"cm-def\"\u003Efeathers\u003C\/span\u003E(\u003Cspan class=\"cm-variable-2\"\u003Eself\u003C\/span\u003E):\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E        \u003Cspan class=\"cm-keyword\"\u003Eprint\u003C\/span\u003E(\u003Cspan class=\"cm-string\"\u003E&quot;The duck has white and gray feathers.&quot;\u003C\/span\u003E)\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":26,"lines_more":21,"preview_is_truncated":false,"channels":["C8QH4KBTP"],"groups":[],"ims":[],"comments_count":0};
...
<!-- slack-www-hhvm-096c07a1593884721 / 2018-03-06 20:44:32 / vea5b484adc53ac4f7a8ae598fc5765165102d812 / B:H -->
